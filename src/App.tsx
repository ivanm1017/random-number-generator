...
export default function App() {
  ...
  }, [timer, lastTrigger, generateNumber]);
    ...
    <div className="min-h-screen bg-zinc-100 flex items-center justify-center p-4 font-sans text-zinc-900">
      <div className="bg-white rounded-[2rem] shadow-2xl shadow-zinc-200/50 border border-zinc-200/60 w-full max-w-md overflow-hidden">
        ...
        <div className="bg-zinc-900 text-white p-6 text-center">
          ...
          <p className="text-zinc-400 text-sm mt-1">Generate integers instantly</p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-4 pt-2">
            ...
            <button
              ...
              className="flex-1 bg-zinc-900 hover:bg-zinc-800 text-white rounded-2xl py-4 px-6 font-bold text-lg flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow-lg shadow-zinc-900/20"
            >
